package cn.minglg.resume.utils;
...
public class FileUtils {
     ...
     * 文件提取核心方法，从文件中提取内容
     *
     * @param autoDetectParser 文件解析器
     * @param is               文件输入流
     * @return 提取结果
     * @throws Exception 异常
     */
    public static String getContentFromFile(AutoDetectParser autoDetectParser, InputStream is) throws Exception {
     ...
     * @return 处理后的结果
     */
    private static String removeAllBlankLines(String content) {
     ...
     * @return 处理后的结果
     */
    private static String trimLineEnds(String content) {
        return Arrays.stream(content.split("\n"))
                .map(String::trim)
                .collect(Collectors.joining("\n"));
    }
     ...
     * @return 处理后的结果
     */
    private static String reduceInternalSpaces(String content) {
